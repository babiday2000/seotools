...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
    return (_jsx(DayPicker, { showOutsideDays: showOutsideDays, className: cn(className), classNames: {
            ...
            Dropdown: ({ value, onChange, children }) => {
                ...
                return (_jsxs(Select, { value: value?.toString(), onValueChange: (value) => {
                        handleChange(value);
                    }, children: [_jsx(SelectTrigger, { className: "w-fit pr-1.5 focus:ring-0", children: _jsx(SelectValue, { children: selected?.props?.children }) }), _jsx(SelectContent, { position: "popper", children: options.map((option, id) => (_jsx(SelectItem, { value: option.props.value?.toString() ?? '', children: option.props.children }, `${option.props.value}-${id}`))) })] }));
            },
        }, ...props }));
}
